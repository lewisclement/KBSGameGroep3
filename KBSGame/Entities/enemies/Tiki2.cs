...
namespace KBSGame
{
    public class Tiki2 : Entity
    {
		static int radius = 5;

        public Tiki2(PointF location, Byte height = 50, bool solid = true, Byte depth = 8, float boundingBox = 0.6f)
            : base(ENTITIES.enemy, location, (int)SPRITES.tiki2, solid, height, depth, boundingBox)
        {
