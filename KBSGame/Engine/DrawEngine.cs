...
namespace KBSGame
{
	public class DrawEngine
	{
		...
		public DrawEngine (World world, Graphics drawingArea, int xResolution, int yResolution)
		{
            ...
            FinishMenu finishmenu = new FinishMenu((int)GUI.finish, xRes, yRes, "Finished!", world); //Create FinishedMenu GUI
			Interfaces.Add(finishmenu);

			GameOverMenu gameover = new GameOverMenu((int)GUI.gameover, xRes, yRes, "Oh no.. you died?", world);
